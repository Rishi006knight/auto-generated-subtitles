...
function resampleTo16k(audioBuffer: Float32Array, sourceRate: number, targetRate: number): Float32Array {
...
function notifyStatus(status: "idle" | "connecting" | "connected" | "error") {
  chrome.runtime.sendMessage({
    target: "background",
    type: "STATUS_UPDATE",
